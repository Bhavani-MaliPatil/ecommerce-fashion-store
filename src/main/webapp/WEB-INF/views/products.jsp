...
<nav class="top-nav">
  ...
  <ul class="nav-links">
    <% if (user != null) { %>
      <li><a href="${pageContext.request.contextPath}/user?action=profile">
...
<div class="page-body">
  ...
  <div class="filter-bar">
    ...
    <a href="${pageContext.request.contextPath}/products"
       class="filter-link <%= categoryId.isEmpty() && keyword.isEmpty() ? "active" : "" %>">
      All
    </a>
    ...
    <a href="${pageContext.request.contextPath}/products?categoryId=1"
       class="filter-link <%= "1".equals(categoryId) ? "active" : "" %>">
      Men
    </a>
    ...
    <a href="${pageContext.request.contextPath}/products?categoryId=2"
       class="filter-link <%= "2".equals(categoryId) ? "active" : "" %>">
      Women
    </a>
          ...
          <div class="product-card">
            ...
            <div class="card-img-wrap">
              ...
              <% } else { %>
                <div class="product-img-placeholder">
                  ...
                  <span style="font-size:11px; letter-spacing:1px;">No image</span>
                </div>
              <% } %>
            </div>
            ...
            <div class="card-body">
              <p class="product-category-tag">
                <%= "1".equals(String.valueOf(p.getCategoryId())) ? "Men" : "Women" %>
              </p>
            ...
            <div class="card-actions">
              <a href="${pageContext.request.contextPath}/product-details?id=<%= p.getId() %>"
                 class="btn-view">
                View Details
              </a>
            </div>
